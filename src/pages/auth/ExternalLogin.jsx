  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F0F2F5] relative overflow-hidden px-4">
      ...
      >
        ...
        {/* Title */}
        <h2 className="text-2xl font-bold text-gray-800">Student & Parent Portal</h2>
        <p className="text-sm text-gray-500 -mt-2">Access your school information</p>
        <p className="text-xs text-[#7C8B9C] -mt-2">For students and parents/guardians</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
          ...
          <div className="text-sm text-gray-500 bg-blue-50 p-3 rounded-md text-left border-l-4 border-blue-500">
            ...
            <ul className="list-disc pl-5 mt-1">
              <li>Student: student@example.com (any password)</li>
              <li>Parent: parent@example.com (any password)</li>
            </ul>
          </div>
