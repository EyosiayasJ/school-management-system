  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F0F2F5] relative overflow-hidden px-4">
      ...
      >
        ...
        {/* Title */}
        <h2 className="text-2xl font-bold text-gray-800">Platform Admin Portal</h2>
        <p className="text-sm text-gray-500 -mt-2">Please login with your admin credentials</p>
        <p className="text-xs text-[#7C8B9C] -mt-2">Super Admin & Support Admin access only</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
          ...
          <div className="text-sm text-gray-500 bg-blue-50 p-3 rounded-md text-left border-l-4 border-blue-500">
            ...
            <ul className="list-disc pl-5 mt-1">
              <li>Super Admin: super@admin.com (any password)</li>
              <li>Support Admin: support@admin.com (any password)</li>
            </ul>
          </div>
          ...
          <div className="mt-4 text-sm text-gray-600">
            ...
            <Link to="/login/internal" className="text-blue-600 hover:underline">
